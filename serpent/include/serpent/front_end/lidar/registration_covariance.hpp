...
public:
    ...
    static_assert(std::is_floating_point<decltype(PointTarget::z)>::value, "z is not a floating point type");
    static_assert(
            std::is_floating_point<decltype(PointTarget::normal_x)>::value, "normal_x is not a floating point type");
    static_assert(
            std::is_floating_point<decltype(PointTarget::normal_y)>::value, "normal_y is not a floating point type");
    static_assert(
            std::is_floating_point<decltype(PointTarget::normal_z)>::value, "normal_z is not a floating point type");
...
#include "serpent/front_end/lidar/registration_covariance-inl.hpp"

...
#include "serpent/front_end/stereo/stereo_cost_functions.hpp"
...
protected:
    virtual MatchingCostFunction generate_cost_function(
            const cv::Mat& reference_image, const cv::Point2i& reference_top_left) const = 0;
...
protected:
     ...
     */
    MatchingCostFunction generate_cost_function(
            const cv::Mat& reference_image, const cv::Point2i& reference_top_left) const override;
};

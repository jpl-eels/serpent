...
public:
    virtual Eigen::Matrix<double, 6, 6> compute_half_d2F_dx2(const PrecomputedTransformComponents<double>& tf,
            const Eigen::Matrix<double, 3, 1>& p, const Eigen::Matrix<double, 3, 1>& q) const = 0;

    virtual Eigen::Matrix<double, 6, 6> compute_half_d2F_dzdx(const PrecomputedTransformComponents<double>& tf,
            const Eigen::Matrix<double, 3, 1>& p, const Eigen::Matrix<double, 3, 1>& q) const = 0;
...
public:
    Eigen::Matrix<double, 6, 6> compute_half_d2F_dx2(const PrecomputedTransformComponents<double>& tf,
            const Eigen::Matrix<double, 3, 1>& p, const Eigen::Matrix<double, 3, 1>& q) const override;

    Eigen::Matrix<double, 6, 6> compute_half_d2F_dzdx(const PrecomputedTransformComponents<double>& tf,
            const Eigen::Matrix<double, 3, 1>& p, const Eigen::Matrix<double, 3, 1>& q) const override;
};
...
template<typename PointSource, typename PointTarget, typename Scalar>
Eigen::Matrix<double, 6, 6> PointToPointIcpNonlinear<PointSource, PointTarget, Scalar>::compute_half_d2F_dx2(
...
template<typename PointSource, typename PointTarget, typename Scalar>
Eigen::Matrix<double, 6, 6> PointToPointIcpNonlinear<PointSource, PointTarget, Scalar>::compute_half_d2F_dzdx(
        const PrecomputedTransformComponents<double>& tf, const Eigen::Matrix<double, 3, 1>& p,
        const Eigen::Matrix<double, 3, 1>& q) const {
    // Aliases
    const double rx{tf.r()[0]};
...
template<typename PointSource, typename PointTarget, typename Scalar>
Eigen::Matrix<double, 6, 6> PointToPointIcpLinearised<PointSource, PointTarget, Scalar>::compute_half_d2F_dx2(
        const PrecomputedTransformComponents<double>&, const Eigen::Matrix<double, 3, 1>& p,
        const Eigen::Matrix<double, 3, 1>& q) const {
...
template<typename PointSource, typename PointTarget, typename Scalar>
Eigen::Matrix<double, 6, 6> PointToPointIcpLinearised<PointSource, PointTarget, Scalar>::compute_half_d2F_dzdx(
        const PrecomputedTransformComponents<double>& tf, const Eigen::Matrix<double, 3, 1>& p,
        const Eigen::Matrix<double, 3, 1>& q) const {
    // Compute required quantities once
...
template<typename PointSource, typename PointTarget, typename Scalar>
Eigen::Matrix<double, 6, 6> PointToPlaneIcpNonlinear<PointSource, PointTarget, Scalar>::compute_half_d2F_dx2(
        const PrecomputedTransformComponents<double>& tf, const Eigen::Matrix<double, 3, 1>& p,
...
template<typename PointSource, typename PointTarget, typename Scalar>
Eigen::Matrix<double, 6, 6> PointToPlaneIcpNonlinear<PointSource, PointTarget, Scalar>::compute_half_d2F_dzdx(
        const PrecomputedTransformComponents<double>& tf, const Eigen::Matrix<double, 3, 1>& p,
        const Eigen::Matrix<double, 3, 1>& q, const Eigen::Matrix<double, 3, 1>& n) const {
    // Aliases
    const double rx{tf.r()[0]};
...
template<typename PointSource, typename PointTarget, typename Scalar>
Eigen::Matrix<double, 6, 6> PointToPlaneIcpLinearised<PointSource, PointTarget, Scalar>::compute_half_d2F_dx2(
        const PrecomputedTransformComponents<double>&, const Eigen::Matrix<double, 3, 1>& p,
        const Eigen::Matrix<double, 3, 1>& q, const Eigen::Matrix<double, 3, 1>& n) const {
    // Compute required quantities once
...
template<typename PointSource, typename PointTarget, typename Scalar>
Eigen::Matrix<double, 6, 6> PointToPlaneIcpLinearised<PointSource, PointTarget, Scalar>::compute_half_d2F_dzdx(
        const PrecomputedTransformComponents<double>& tf, const Eigen::Matrix<double, 3, 1>& p,
        const Eigen::Matrix<double, 3, 1>& q, const Eigen::Matrix<double, 3, 1>& n) const {
    // Compute required quantities once
    const Eigen::Vector3d p_cross_n = p.cross(n);

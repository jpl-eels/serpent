...
Eigen::Matrix<Scalar, 6, 1> point_to_point_jacobian(const Eigen::Matrix<Scalar, 3, 3>& R,
    ...
    /*
        ...
        where
           ...
           #2 == rx  + ry  + rz
    */
    dG_dx(0, 0) = p[0] * ((rx3 * sina) / a2_3on2 + (2.0 * rx3 * cosa_m1) / a2_2 - (r[0] * sina) / a -
                                 (2.0 * r[0] * cosa_m1) / a2) +
                  p[1] * ((r[0] * r[2] * sina) / a2_3on2 - (r[0] * r[2] * cosa) / a2 - (r[1] * cosa_m1) / a2 +
                                 (rx2 * r[1] * sina) / a2_3on2 + (2.0 * rx2 * r[1] * cosa_m1) / a2_2) +
                  p[2] * (-(r[0] * r[1] * sina) / a2_3on2 - (r[2] * cosa_m1) / a2 + (r[0] * r[1] * cosa) / a2 +
                                 (rx2 * r[2] * sina) / a2_3on2 + (2.0 * rx2 * r[2] * cosa_m1) / a2_2);
    /*
           /   2                                           2       \
    ...
    */
    dG_dx(0, 1) = p[0] * ((rx2 * r[1] * sina) / a2_3on2 - (r[1] * sina) / a + (2.0 * rx2 * r[1] * cosa_m1) / a2_2) +
                  p[1] * ((r[1] * r[2] * sina) / a2_3on2 - (r[0] * cosa_m1) / a2 - (r[1] * r[2] * cosa) / a2 +
                                 (r[0] * ry2 * sina) / a2_3on2 + (2.0 * r[0] * ry2 * cosa_m1) / a2_2) +
                  p[2] * ((sina) / a + (ry2 * cosa) / a2 - (ry2 * sina) / a2_3on2 + (rxryrz * sina) / a2_3on2 +
                                 (2.0 * rxryrz * cosa_m1) / a2_2);
    /*
           /   2                                           2       \
    ...
    */
    dG_dx(0, 2) = p[0] * ((rx2 * r[2] * sina) / a2_3on2 - (r[2] * sina) / a + (2.0 * rx2 * r[2] * cosa_m1) / a2_2) +
                  p[2] * (-(r[1] * r[2] * sina) / a2_3on2 - (r[0] * cosa_m1) / a2 + (r[1] * r[2] * cosa) / a2 +
                                 (r[0] * rz2 * sina) / a2_3on2 + (2.0 * r[0] * rz2 * cosa_m1) / a2_2) +
                  p[1] * (-(rz2 * cosa) / a2 - (sina) / a + (rz2 * sina) / a2_3on2 + (rxryrz * sina) / a2_3on2 +
                                 (2.0 * rxryrz * cosa_m1) / a2_2);
    /*
           /      2                                           2    \
    ...
    */
    dG_dx(1, 0) = p[1] * ((r[0] * ry2 * sina) / a2_3on2 - (r[0] * sina) / a + (2.0 * r[0] * ry2 * cosa_m1) / a2_2) +
                  p[0] * (-(r[0] * r[2] * sina) / a2_3on2 - (r[1] * cosa_m1) / a2 + (r[0] * r[2] * cosa) / a2 +
                                 (rx2 * r[1] * sina) / a2_3on2 + (2.0 * rx2 * r[1] * cosa_m1) / a2_2) +
                  p[2] * (-(rx2 * cosa) / a2 - (sina) / a + (rx2 * sina) / a2_3on2 + (rxryrz * sina) / a2_3on2 +
                                 (2.0 * rxryrz * cosa_m1) / a2_2);
    /*
           /   3                     3                                 \
        ...
        where
           ...
           #2 == rx  + ry  + rz
    */
    dG_dx(1, 1) = p[1] * ((ry3 * sina) / a2_3on2 + (2.0 * ry3 * cosa_m1) / a2_2 - (r[1] * sina) / a -
                                 (2.0 * r[1] * cosa_m1) / a2) +
                  p[0] * (-(r[1] * r[2] * sina) / a2_3on2 - (r[0] * cosa_m1) / a2 + (r[1] * r[2] * cosa) / a2 +
                                 (r[0] * ry2 * sina) / a2_3on2 + (2.0 * r[0] * ry2 * cosa_m1) / a2_2) +
                  p[2] * ((r[0] * r[1] * sina) / a2_3on2 - (r[2] * cosa_m1) / a2 - (r[0] * r[1] * cosa) / a2 +
                                 (ry2 * r[2] * sina) / a2_3on2 + (2.0 * ry2 * r[2] * cosa_m1) / a2_2);
    /*
           /   2                                           2       \
    ...
    */
    dG_dx(1, 2) = p[1] * ((ry2 * r[2] * sina) / a2_3on2 - (r[2] * sina) / a + (2.0 * ry2 * r[2] * cosa_m1) / a2_2) +
                  p[2] * ((r[0] * r[2] * sina) / a2_3on2 - (r[1] * cosa_m1) / a2 - (r[0] * r[2] * cosa) / a2 +
                                 (r[1] * rz2 * sina) / a2_3on2 + (2.0 * r[1] * rz2 * cosa_m1) / a2_2) +
                  p[0] * ((sina) / a + (rz2 * cosa) / a2 - (rz2 * sina) / a2_3on2 + (rxryrz * sina) / a2_3on2 +
                                 (2.0 * rxryrz * cosa_m1) / a2_2);
    /*
           /      2                                           2    \
    ...
    */
    dG_dx(2, 0) = p[2] * ((r[0] * rz2 * sina) / a2_3on2 - (r[0] * sina) / a + (2.0 * r[0] * rz2 * cosa_m1) / a2_2) +
                  p[0] * ((r[0] * r[1] * sina) / a2_3on2 - (r[2] * cosa_m1) / a2 - (r[0] * r[1] * cosa) / a2 +
                                 (rx2 * r[2] * sina) / a2_3on2 + (2.0 * rx2 * r[2] * cosa_m1) / a2_2) +
                  p[1] * ((sina) / a + (rx2 * cosa) / a2 - (rx2 * sina) / a2_3on2 + (rxryrz * sina) / a2_3on2 +
                                 (2.0 * rxryrz * cosa_m1) / a2_2);
    /*
           /      2                                           2    \
    ...
    */
    dG_dx(2, 1) = p[2] * ((r[1] * rz2 * sina) / a2_3on2 - (r[1] * sina) / a + (2.0 * r[1] * rz2 * cosa_m1) / a2_2) +
                  p[1] * (-(r[0] * r[1] * sina) / a2_3on2 - (r[2] * cosa_m1) / a2 + (r[0] * r[1] * cosa) / a2 +
                                 (ry2 * r[2] * sina) / a2_3on2 + (2.0 * ry2 * r[2] * cosa_m1) / a2_2) +
                  p[0] * (-(ry2 * cosa) / a2 - (sina) / a + (ry2 * sina) / a2_3on2 + (rxryrz * sina) / a2_3on2 +
                                 (2.0 * rxryrz * cosa_m1) / a2_2);
    /*
           /   3                     3                                 \
        ...
        where
           ...
           #2 == rx  + ry  + rz
    */
    dG_dx(2, 2) = p[2] * ((rz3 * sina) / a2_3on2 + (2.0 * rz3 * cosa_m1) / a2_2 - (r[2] * sina) / a -
                                 (2.0 * r[2] * cosa_m1) / a2) +
                  p[0] * ((r[1] * r[2] * sina) / a2_3on2 - (r[0] * cosa_m1) / a2 - (r[1] * r[2] * cosa) / a2 +
                                 (r[0] * rz2 * sina) / a2_3on2 + (2.0 * r[0] * rz2 * cosa_m1) / a2_2) +
                  p[1] * (-(r[0] * r[2] * sina) / a2_3on2 - (r[1] * cosa_m1) / a2 + (r[0] * r[2] * cosa) / a2 +
                                 (r[1] * rz2 * sina) / a2_3on2 + (2.0 * r[1] * rz2 * cosa_m1) / a2_2);
...
Eigen::Matrix<Scalar, 6, 1> point_to_plane_jacobian(const Eigen::Matrix<Scalar, 3, 1>& t,
    ...
    J(0, 0) = (2 * nx *
                              (px * ((rx3 * sina) / a2_3on2 + (2 * rx3 * cosa_m1) / a2_2 - (rx * sina) / a -
                                            (2 * rx * cosa_m1) / a2) +
                                      py * ((rx * rz * sina) / a2_3on2 - (rx * rz * cosa) / a2 - (ry * cosa_m1) / a2 +
                                                   (rx2 * ry * sina) / a2_3on2 + (2 * rx2 * ry * cosa_m1) / a2_2) +
                                      pz * ((rx * ry * cosa) / a2 - (rz * cosa_m1) / a2 - (rx * ry * sina) / a2_3on2 +
                                                   (rx2 * rz * sina) / a2_3on2 + (2 * rx2 * rz * cosa_m1) / a2_2)) +
                      2 * ny *
                              (py * ((rx * ry2 * sina) / a2_3on2 - (rx * sina) / a + (2 * rx * ry2 * cosa_m1) / a2_2) +
                                      px * ((rx * rz * cosa) / a2 - (ry * cosa_m1) / a2 - (rx * rz * sina) / a2_3on2 +
                                                   (rx2 * ry * sina) / a2_3on2 + (2 * rx2 * ry * cosa_m1) / a2_2) +
                                      pz * ((rx2 * sina) / a2_3on2 - sina / a - (rx2 * cosa) / a2 +
                                                   (rxryrz * sina) / a2_3on2 + (2 * rxryrz * cosa_m1) / a2_2)) +
                      2 * nz *
                              (pz * ((rx * rz2 * sina) / a2_3on2 - (rx * sina) / a + (2 * rx * rz2 * cosa_m1) / a2_2) +
                                      px * ((rx * ry * sina) / a2_3on2 - (rx * ry * cosa) / a2 - (rz * cosa_m1) / a2 +
                                                   (rx2 * rz * sina) / a2_3on2 + (2 * rx2 * rz * cosa_m1) / a2_2) +
                                      py * (sina / a - (rx2 * sina) / a2_3on2 + (rx2 * cosa) / a2 +
                                                   (rxryrz * sina) / a2_3on2 + (2 * rxryrz * cosa_m1) / a2_2))) *
              (nx * (tx - qx + px * (cosa - (rx2 * cosa_m1) / a2) - py * ((rz * sina) / a + (rx * ry * cosa_m1) / a2) +
                            pz * ((ry * sina) / a - (rx * rz * cosa_m1) / a2)) +
                      ny * (ty - qy + py * (cosa - (ry2 * cosa_m1) / a2) +
                                   px * ((rz * sina) / a - (rx * ry * cosa_m1) / a2) -
                                   pz * ((rx * sina) / a + (ry * rz * cosa_m1) / a2)) +
                      nz * (tz - qz + pz * (cosa - (rz2 * cosa_m1) / a2) -
                                   px * ((ry * sina) / a + (rx * rz * cosa_m1) / a2) +
                                   py * ((rx * sina) / a - (ry * rz * cosa_m1) / a2)));
    J(1, 0) = (2 * ny *
                              (py * ((ry3 * sina) / a2_3on2 + (2 * ry3 * cosa_m1) / a2_2 - (ry * sina) / a -
                                            (2 * ry * cosa_m1) / a2) +
                                      px * ((ry * rz * cosa) / a2 - (rx * cosa_m1) / a2 - (ry * rz * sina) / a2_3on2 +
                                                   (rx * ry2 * sina) / a2_3on2 + (2 * rx * ry2 * cosa_m1) / a2_2) +
                                      pz * ((rx * ry * sina) / a2_3on2 - (rx * ry * cosa) / a2 - (rz * cosa_m1) / a2 +
                                                   (ry2 * rz * sina) / a2_3on2 + (2 * ry2 * rz * cosa_m1) / a2_2)) +
                      2 * nx *
                              (px * ((rx2 * ry * sina) / a2_3on2 - (ry * sina) / a + (2 * rx2 * ry * cosa_m1) / a2_2) +
                                      py * ((ry * rz * sina) / a2_3on2 - (ry * rz * cosa) / a2 - (rx * cosa_m1) / a2 +
                                                   (rx * ry2 * sina) / a2_3on2 + (2 * rx * ry2 * cosa_m1) / a2_2) +
                                      pz * (sina / a - (ry2 * sina) / a2_3on2 + (ry2 * cosa) / a2 +
                                                   (rxryrz * sina) / a2_3on2 + (2 * rxryrz * cosa_m1) / a2_2)) +
                      2 * nz *
                              (pz * ((ry * rz2 * sina) / a2_3on2 - (ry * sina) / a + (2 * ry * rz2 * cosa_m1) / a2_2) +
                                      py * ((rx * ry * cosa) / a2 - (rz * cosa_m1) / a2 - (rx * ry * sina) / a2_3on2 +
                                                   (ry2 * rz * sina) / a2_3on2 + (2 * ry2 * rz * cosa_m1) / a2_2) +
                                      px * ((ry2 * sina) / a2_3on2 - sina / a - (ry2 * cosa) / a2 +
                                                   (rxryrz * sina) / a2_3on2 + (2 * rxryrz * cosa_m1) / a2_2))) *
              (nx * (tx - qx + px * (cosa - (rx2 * cosa_m1) / a2) - py * ((rz * sina) / a + (rx * ry * cosa_m1) / a2) +
                            pz * ((ry * sina) / a - (rx * rz * cosa_m1) / a2)) +
                      ny * (ty - qy + py * (cosa - (ry2 * cosa_m1) / a2) +
                      ...
                      nz * (tz - qz + pz * (cosa - (rz2 * cosa_m1) / a2) -
                                   ...
                                   py * ((rx * sina) / a - (ry * rz * cosa_m1) / a2)));
    J(2, 0) = (2 * nz *
                              (pz * ((rz3 * sina) / a2_3on2 + (2 * rz3 * cosa_m1) / a2_2 - (rz * sina) / a -
                                            (2 * rz * cosa_m1) / a2) +
                                      px * ((ry * rz * sina) / a2_3on2 - (ry * rz * cosa) / a2 - (rx * cosa_m1) / a2 +
                                                   (rx * rz2 * sina) / a2_3on2 + (2 * rx * rz2 * cosa_m1) / a2_2) +
                                      py * ((rx * rz * cosa) / a2 - (ry * cosa_m1) / a2 - (rx * rz * sina) / a2_3on2 +
                                                   (ry * rz2 * sina) / a2_3on2 + (2 * ry * rz2 * cosa_m1) / a2_2)) +
                      2 * nx *
                              (px * ((rx2 * rz * sina) / a2_3on2 - (rz * sina) / a + (2 * rx2 * rz * cosa_m1) / a2_2) +
                                      pz * ((ry * rz * cosa) / a2 - (rx * cosa_m1) / a2 - (ry * rz * sina) / a2_3on2 +
                                                   (rx * rz2 * sina) / a2_3on2 + (2 * rx * rz2 * cosa_m1) / a2_2) +
                                      py * ((rz2 * sina) / a2_3on2 - sina / a - (rz2 * cosa) / a2 +
                                                   (rxryrz * sina) / a2_3on2 + (2 * rxryrz * cosa_m1) / a2_2)) +
                      2 * ny *
                              (py * ((ry2 * rz * sina) / a2_3on2 - (rz * sina) / a + (2 * ry2 * rz * cosa_m1) / a2_2) +
                                      pz * ((rx * rz * sina) / a2_3on2 - (rx * rz * cosa) / a2 - (ry * cosa_m1) / a2 +
                                                   (ry * rz2 * sina) / a2_3on2 + (2 * ry * rz2 * cosa_m1) / a2_2) +
                                      px * (sina / a - (rz2 * sina) / a2_3on2 + (rz2 * cosa) / a2 +
                                                   (rxryrz * sina) / a2_3on2 + (2 * rxryrz * cosa_m1) / a2_2))) *
              (nx * (tx - qx + px * (cosa - (rx2 * cosa_m1) / a2) - py * ((rz * sina) / a + (rx * ry * cosa_m1) / a2) +
                            pz * ((ry * sina) / a - (rx * rz * cosa_m1) / a2)) +
                      ny * (ty - qy + py * (cosa - (ry2 * cosa_m1) / a2) +

...
public:
    ...
    void create_prior_imu_bias_factor(
            const int key, const gtsam::imuBias::ConstantBias& imu_bias, gtsam::SharedNoiseModel noise);
...
#include "serpent/back_end/graph_manager-inl.hpp"

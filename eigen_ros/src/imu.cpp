...
Imu::Imu(const Eigen::Quaterniond& orientation, const Eigen::Vector3d& angular_velocity,
    ...
    orientation(orientation), angular_velocity(angular_velocity), linear_acceleration(linear_acceleration),
    orientation_covariance(orientation_covariance), angular_velocity_covariance(angular_velocity_covariance),

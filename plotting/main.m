...
config.data_dir = join([config.gt.data_dir, "serpent_results/", ...
    "thesis_summary/"], "");
config.filenames = ["odometry_s2s_fast_gicp_2022-08-16-11-44-53.bag", ...
    "odometry_s2m_fast_gicp_2022-08-16-11-54-50.bag", ...
    "odometry_s2s_fast_vgicp_2022-08-16-13-16-24.bag", ...
    "odometry_s2m_fast_vgicp_2022-08-16-13-23-12.bag", ...
    "odometry_s2m_imu_fast_gicp_2022-08-16-13-51-46.bag", ...
    "odometry_s2m_imu_fixed_fast_gicp_2022-08-16-14-12-08.bag", ...
    "odometry_s2m_imu_fixed_mdcrot_fast_gicp_2022-08-16-14-28-56.bag"];
config.names = ["S2S GICP", ...
    "S2M GICP", ...
    "S2S VGICP", ...
    "S2M VGICP", ...
    "S2M+IMU GICP (aug cov)", ...
    "S2M+IMU GICP (fix cov)", ...
    "S2M+IMU GICP (fix cov) MDC (rot)"];

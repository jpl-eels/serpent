function plot_opts = default_plot_opts()
    ...
    % After 7 I made them up
    plot_opts.colours = {[0 0.4470 0.7410], [0.8500 0.3250 0.0980], ...
        [0.9290 0.6940 0.1250], [0.4940 0.1840 0.5560], ...
        [0.4660 0.6740 0.1880], [0.3010 0.7450 0.9330], ...
        [0.6350 0.0780 0.1840], [0.7, 0.3, 0.7], [0.4, 0.1, 0.9], ...
        [0.6, 0.9, 0.1], [0.2, 0.6, 0.5], [0.0, 0.7, 0.3], ...
        [0.7, 0.0, 0.3], [0.0, 0.3, 0.7], [0.3, 0.0, 0.7], ...
        [0.7, 0.3, 0.0], [0.3, 0.7, 0.0]};
    plot_opts.gt_linespec = 'k--';
    plot_opts.save = false;
    plot_opts.save_dir = "";
    plot_opts.filetypes = ["fig", "png", "svg"];
    plot_opts.close_figures = false;
    plot_opts.time_bounds = struct;
    plot_opts.time_bounds.filter = false;
    plot_opts.time_bounds.start = 0;
    plot_opts.time_bounds.duration = 0;
end